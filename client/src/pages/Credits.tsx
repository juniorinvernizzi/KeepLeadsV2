...
export default function Credits() {
  ...
  if (paymentStatus) {
    if (paymentStatus === "success") {
      ...
      toast({
        ...
        description:
          "O pagamento foi cancelado. Tente novamente se necessário.",
        variant: "destructive",
      });
  ...
  const predefinedAmounts = [
    { value: 50, label: "R$ 50,00", description: "" },
    { value: 100, label: "R$ 100,00", description: "" },
    { value: 250, label: "R$ 250,00", description: "" },
    { value: 500, label: "R$ 500,00", description: "", popular: true },
  ];
      ...
      <div className="w-9/10 mx-auto py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Adicione créditos para comprar leads ou visualize seu histórico
          </p>
        </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {predefinedAmounts.map((amount) => (
                  ...
                  >
                    ...
                    <div
                      className={`text-sm ${amount.popular ? "text-primary font-medium" : "text-slate-500"}`}
                    >
                      {amount.description}
                  ...
                  >
                    ...
                    <div className="ml-3 flex items-center">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm0 2v1h12V6H4zm0 3v5h12V9H4z"
                          clipRule="evenodd"
                        />
                      </svg>
                  ...
                  >
                    ...
                    <div className="ml-3 flex items-center">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M3 4a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 13a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H4a1 1 0 01-1-1v-3zM13 3a1 1 0 00-1 1v3a1 1 0 001 1h3a1 1 0 001-1V4a1 1 0 00-1-1h-3z"
                          clipRule="evenodd"
                        />
                      </svg>
                  ...
                  {transactions.slice(0, 10).map((transaction) => (
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div
                            ...
                            data-testid={`text-date-${transaction.id}`}
                          >
                            {formatDistanceToNow(
                      ...
                      <div className="text-right">
                        <div
                          className={`text-sm font-semibold ${getTransactionAmountClass(transaction.type)}`}
